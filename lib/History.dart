...
class HistoryItem {
  ...
  final String
  orderId; // Keeping as String for simplicity in display, but treated as numeric for search
                ...
                children: [
                  ...
                  if (tempRating > 0)
                    Padding(
                      ...
                      child: Text(
                        'Selected: ${tempRating.toStringAsFixed(1)}/5',
                      ),
                    ),
                ],
              ),
              actions: <Widget>[
                ...
                ElevatedButton(
                  ...
                  onPressed: tempRating > 0
                      ? () {
                          debugPrint(
                            'Submitting Rating: ${item.bookName} rated $tempRating/5',
                          );
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                if (reviewText.isNotEmpty) {
                  debugPrint(
                    'Submitting Review for ${item.bookName}: "$reviewText"',
                  );
          ...
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                _buildInfoRow('Rent Status', _buildRentStatusChip()),
            ...
            child: Column(
              children: [
                ...
                IconButton(
                  ...
                  onPressed: _isReviewable
                      ? () => onComment(item)
                      : null, // Disable if not reviewable
                ),
                ...
                IconButton(
                  ...
                  icon: Icon(
                    Icons
                        .star_border, // Use border icon to match the original screenshot
